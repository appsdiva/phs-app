...
import { FaHome, FaUserGraduate, FaCalendarAlt, FaBasketballBall } from 'react-icons/fa';
import '../MapPage.css';
    ...
    const handleButtonClick = (route) => {
      ...
      return (
        <div className="school-map-container" style={backgroundImage}>
          ...
          <TransformWrapper>
            <TransformComponent>
              <img src={LowerLevelMap} alt="School Map" className="school-map-image" />
            </TransformComponent>
          </TransformWrapper>
